...
class TestDepartment:
    ...
    def test_saves_department(self):
        '''contains method "save_data()" that saves a Department instance to the db and assigns the instance an id.'''
    ...
    def test_updates_row(self):
        '''contains a method "update_data()" that updates an instance's corresponding db row to match its new attribute values.'''
        Department.create_table()
    ...
    def test_deletes_record(self):
        '''contains a method "delete_data()" that deletes the instance's corresponding db row'''
        Department.create_table()
